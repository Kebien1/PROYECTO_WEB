...
if($_POST){
    ...
    if($usuario == "" || $clave == "" || $Email == "" ) {
        ...
        // REDIRECCIONA AL INICIO AL TERMINAR
...
<?php 
// CARGA LA CABECERA DE LA PAGINA
include("header.php") 
?>
