...
// VERIFICA SI SE ENVIO UN ID PARA BORRAR
if(isset($_GET['txtID'])){
    $txtID = (isset($_GET['txtID']))?$_GET['txtID']:"";
    
    // BUSCA EL REGISTRO ANTES DE BORRAR
    ...
    // REDIRECCIONA CON UN MENSAJE DE EXITO
...
<?php 
// MUESTRA UNA ALERTA SI HAY UN MENSAJE PENDIENTE
    ...
    <div class="card-body">
        <div class="table-responsive-sm">
            <table class="table table-bordered  tabla-usuarios">
                ...
                <tbody>
                    <?php 
                    // RECORRE LA LISTA DE USUARIOS UNO POR UNO
                    ...
                    <tr>
                        ...
                        <td>
                            <!--
                            <a class="btn btn-outline-success" href="usuario_permisos.php?idUsuario=<?php echo $registro['ID']; ?>" role="button">
